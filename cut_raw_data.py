...
if __name__ == '__main__':
    ...
    point_data = gpd.read_file(path + "\Skred_Skredhendelse.shp")

    slushflows = point_data[point_data['skredType'] == 133] # find points with tag 133 which are the recoarded slushflow events
    ...
    # these lines are used to make data files consisting of only slushflows for loading in QGIS
